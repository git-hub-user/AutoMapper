...
namespace AutoMapper
{
    ...
    public abstract class Profile : IProfileExpressionInternal, IProfileConfiguration
    {
        ...
        public void IncludeSourceExtensionMethods(Type type) =>
            _sourceExtensionMethods.AddRange(type.GetMethods(BindingFlags.DeclaredOnly | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic)
                .Where(m => m.IsExtensionMethod() && m.GetParameters().Length == 1));
    }
}