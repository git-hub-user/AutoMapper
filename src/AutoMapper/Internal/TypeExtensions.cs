...
namespace AutoMapper.Internal
{
    public static class TypeExtensions
    {
        ...
        public static MethodInfo GetStaticMethod(this Type type, string name) => type.GetMethod(name, BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.DeclaredOnly);
