...
namespace AutoMapper.Mappers
{
    ...
    public class ImplicitConversionOperatorMapper : ConversionOperatorMapper
    {
        public ImplicitConversionOperatorMapper() : base("op_Implicit") { }
    }
    public class ExplicitConversionOperatorMapper : ConversionOperatorMapper
    {
        public ExplicitConversionOperatorMapper() : base("op_Explicit") { }
    }
}